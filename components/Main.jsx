...
const Main = () => {
  ...
  return (
    <div className="flex flex-col flex-wrap items-center bg-[#f6f6fe] max-lg:w-full lg:h-[100vh]">
      ...
      {/* pricing */}
      <div className="grid text-center max-lg:grid-rows-3 max-lg:gap-y-8 lg:grid-cols-3 max-lg:mb-[85px]">
        {/* first */}
        <div className="pricing-container  max-lg:rounded-lg lg:mb-[85px] lg:ml-[15px] lg:mr-[-15px] lg:rounded-l-lg">
          ...
          {!toggle ? (
            ...
            <p className="pricing-value px-[4.38rem]">
              <span className="pricing-dollar lg:left-[35px] max-lg:left-[40px]">$</span>
              19.99
            </p>
          )}
        ...
        <div className="pricing-container  z-[1] justify-self-center rounded-lg bg-gradient-to-br from-[#a3a8f0] to-[#696fdd] px-7 lg:mt-[-25px] lg:h-[520px] lg:w-[370px] lg:pt-12">
          ...
          {!toggle ? (
            ...
            <p className="pricing-value border-[#a3a8f0] text-white">
              <span className="pricing-dollar lg:left-[15px] border-[#a3a8f0] text-white max-lg:left-[9px] max-lg:top-[18px] ">
                $
              </span>
              24.99
            </p>
        ...
        {/* third */}
        <div className="pricing-container max-lg:rounded-lg lg:mb-[85px] lg:rounded-r-lg lg:ml-[-15px] lg:mr-[15px]">
          ...
          {!toggle ? (
            ...
            <p className="pricing-value ">
              <span className="pricing-dollar lg:left-[30px] max-lg:left-[10px]">$</span>39.99
            </p>
          )}
